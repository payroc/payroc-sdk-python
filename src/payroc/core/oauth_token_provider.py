...
class OAuthTokenProvider:
    ...
    def _refresh(self) -> str:
        token_response = self._auth_client.retrieve_token(api_key=self._client_id, client_id="", client_secret="")
...
class AsyncOAuthTokenProvider:
    ...
    async def _refresh(self) -> str:
        token_response = await self._auth_client.retrieve_token(
            api_key=self._client_id, client_id="", client_secret=""
        )
        self._access_token = token_response.access_token
        self._expires_at = self._get_expires_at(
            expires_in_seconds=token_response.expires_in, buffer_in_minutes=self.BUFFER_IN_MINUTES
