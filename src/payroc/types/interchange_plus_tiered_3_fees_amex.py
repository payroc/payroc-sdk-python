...
class InterchangePlusTiered3FeesAmex_OptBlue(UniversalBaseModel):
    """
...
class InterchangePlusTiered3FeesAmex_Direct(UniversalBaseModel):
    """
    Object that contains the fees for American Express transactions.
    """
...
InterchangePlusTiered3FeesAmex = typing_extensions.Annotated[
    typing.Union[InterchangePlusTiered3FeesAmex_OptBlue, InterchangePlusTiered3FeesAmex_Direct],
