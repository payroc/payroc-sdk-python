...
class Customer(UniversalBaseModel):
    ...
    billing_address: typing_extensions.Annotated[typing.Optional[Address], FieldMetadata(alias="billingAddress")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    notification_language: typing_extensions.Annotated[
        typing.Optional[CustomerNotificationLanguage], FieldMetadata(alias="notificationLanguage")
    ] = pydantic.Field(default=None)
    """
