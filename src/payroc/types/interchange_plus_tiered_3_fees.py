...
from .interchange_plus_tiered_3_fees_amex import InterchangePlusTiered3FeesAmex
from .pin_debit import PinDebit
from .qual_rates import QualRates
from .speciality_cards import SpecialityCards


class InterchangePlusTiered3Fees(UniversalBaseModel):
    """
    ...
    amex: typing.Optional[InterchangePlusTiered3FeesAmex] = pydantic.Field(default=None)
    """
    ...
    enhanced_interchange: typing_extensions.Annotated[
        typing.Optional[EnhancedInterchange],
        FieldMetadata(alias="enhancedInterchange"),
        pydantic.Field(alias="enhancedInterchange"),
    ] = None
