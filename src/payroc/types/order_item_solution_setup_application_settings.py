...
from .order_item_solution_setup_application_settings_security import OrderItemSolutionSetupApplicationSettingsSecurity


class OrderItemSolutionSetupApplicationSettings(UniversalBaseModel):
    """
