...
class RawPricingIntentsClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PaginatedPricingIntent,  # type: ignore
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "country": country,
                "version": version,
                "base": convert_and_respect_annotation_metadata(object_=base, annotation=BaseUs, direction="write"),
                "processor": convert_and_respect_annotation_metadata(
                    object_=processor, annotation=PricingAgreementUs50Processor, direction="write"
                ),
                "gateway": convert_and_respect_annotation_metadata(
                    object_=gateway, annotation=GatewayUs50, direction="write"
                ),
                "services": convert_and_respect_annotation_metadata(
                    object_=services, annotation=ServicesUs50, direction="write"
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    PricingIntent,
                    parse_obj_as(
                        type_=PricingIntent,  # type: ignore
                        object_=_response.json(),
                    ),
                )
    ...
    def retrieve(
        ...
        **Note:** If you don't have the pricingIntentId, use our [List Pricing Intents](https://docs.payroc.com/api/schema/boarding/pricing-intents/list) method to search for the pricing intent.
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"pricing-intents/{jsonable_encoder(pricing_intent_id)}",
            base_url=self._client_wrapper.get_environment().api,
            method="GET",
            request_options=request_options,
        )
...
class AsyncRawPricingIntentsClient:
    ...
    async def create(
        ...
        *,
        ...
        services: typing.Optional[ServicesUs50] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[PricingIntent]:
        """
        Use this method to create a pricing intent that you can assign to a processing account.
