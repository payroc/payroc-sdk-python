...
class RetrievePaymentLinksResponse_MultiUse(UniversalBaseModel):
...
class RetrievePaymentLinksResponse_SingleUse(UniversalBaseModel):
...
RetrievePaymentLinksResponse = typing_extensions.Annotated[
    typing.Union[RetrievePaymentLinksResponse_MultiUse, RetrievePaymentLinksResponse_SingleUse],
