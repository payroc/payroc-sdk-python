...
class CreatePaymentLinksRequestBody_MultiUse(UniversalBaseModel):
...
class CreatePaymentLinksRequestBody_SingleUse(UniversalBaseModel):
...
CreatePaymentLinksRequestBody = typing_extensions.Annotated[
    typing.Union[CreatePaymentLinksRequestBody_MultiUse, CreatePaymentLinksRequestBody_SingleUse],
