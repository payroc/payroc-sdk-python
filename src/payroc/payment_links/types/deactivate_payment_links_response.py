...
class DeactivatePaymentLinksResponse_MultiUse(UniversalBaseModel):
...
class DeactivatePaymentLinksResponse_SingleUse(UniversalBaseModel):
...
DeactivatePaymentLinksResponse = typing_extensions.Annotated[
    typing.Union[DeactivatePaymentLinksResponse_MultiUse, DeactivatePaymentLinksResponse_SingleUse],
