...
class CreatePaymentLinksResponse_MultiUse(UniversalBaseModel):
...
class CreatePaymentLinksResponse_SingleUse(UniversalBaseModel):
...
CreatePaymentLinksResponse = typing_extensions.Annotated[
    typing.Union[CreatePaymentLinksResponse_MultiUse, CreatePaymentLinksResponse_SingleUse],
